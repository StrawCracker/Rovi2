...
bool SerialDeviceServiceInterfaceDummy::moveLin(const TransformAndSpeedAndBlendContainer_t& targets)
{
...
bool SerialDeviceServiceInterfaceDummy::movePtp(const QAndSpeedAndBlendContainer_t& targets)
{
  most_recent_function_called_ = __PRETTY_FUNCTION__;
  if (cause_error_)
  {
...
bool SerialDeviceServiceInterfaceDummy::movePtpT(const TransformAndSpeedAndBlendContainer_t& targets)
{
  most_recent_function_called_ = __PRETTY_FUNCTION__;
  if (cause_error_)
  {
