...
class EmptySrvRequest {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new EmptySrvRequest(null);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new EmptySrvRequest(null);
    return resolved;
    }
};
...
class EmptySrvResponse {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new EmptySrvResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new EmptySrvResponse(null);
...
module.exports = {
  ...
  datatype() { return 'caros_common_msgs/EmptySrv'; }
};
