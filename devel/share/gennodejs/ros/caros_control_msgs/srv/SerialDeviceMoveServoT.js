...
class SerialDeviceMoveServoTRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SerialDeviceMoveServoTRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SerialDeviceMoveServoTRequest
    let len;
    let data = new SerialDeviceMoveServoTRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SerialDeviceMoveServoTRequest(null);
...
class SerialDeviceMoveServoTResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.success = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SerialDeviceMoveServoTResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SerialDeviceMoveServoTResponse
    let len;
    let data = new SerialDeviceMoveServoTResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'caros_control_msgs/SerialDeviceMoveServoTResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SerialDeviceMoveServoTResponse(null);
...
module.exports = {
  Request: SerialDeviceMoveServoTRequest,
  Response: SerialDeviceMoveServoTResponse,
  md5sum() { return '0092a8e71a6ac28671c6e239deeca080'; },
  datatype() { return 'caros_control_msgs/SerialDeviceMoveServoT'; }
};
