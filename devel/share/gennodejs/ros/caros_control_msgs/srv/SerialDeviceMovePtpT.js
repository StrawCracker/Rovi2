...
class SerialDeviceMovePtpTRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SerialDeviceMovePtpTRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SerialDeviceMovePtpTRequest
    let len;
    let data = new SerialDeviceMovePtpTRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new SerialDeviceMovePtpTRequest(null);
...
class SerialDeviceMovePtpTResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.success = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type SerialDeviceMovePtpTResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type SerialDeviceMovePtpTResponse
    let len;
    let data = new SerialDeviceMovePtpTResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'caros_control_msgs/SerialDeviceMovePtpTResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SerialDeviceMovePtpTResponse(null);
...
module.exports = {
  Request: SerialDeviceMovePtpTRequest,
  Response: SerialDeviceMovePtpTResponse,
  md5sum() { return '9d894296389820976b255220f98863da'; },
  datatype() { return 'caros_control_msgs/SerialDeviceMovePtpT'; }
};
