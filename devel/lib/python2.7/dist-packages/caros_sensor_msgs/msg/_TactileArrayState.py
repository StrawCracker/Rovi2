...
"""autogenerated by genpy from caros_sensor_msgs/TactileArrayState.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import caros_sensor_msgs.msg
import std_msgs.msg

class TactileArrayState(genpy.Message):
  _md5sum = "e53557c2a59800894edb24657c7a5331"
  _type = "caros_sensor_msgs/TactileArrayState"
  _has_header = True #flag to mark the presence of a Header object
  _full_text = """# Represents the state of a tactile array sensor. Such a sensor
...
"""
  ...
  _slot_types = ['std_msgs/Header','caros_sensor_msgs/TactileArrayData[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(TactileArrayState, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = caros_sensor_msgs.msg.TactileArrayData()
        _x = val1
        start = end
        end += 8
